...
pub fn draw_help(f: &mut Frame, area: Rect) {
    ...
    let lines = vec![
        ...
        help_line("  Tab", "Cycle sections (Containers→Images→Volumes)"),
        help_line("  1/2/3", "Jump to Containers/Images/Volumes"),
        ...
        help_line("  p", "Prune (stopped containers / dangling images)"),
